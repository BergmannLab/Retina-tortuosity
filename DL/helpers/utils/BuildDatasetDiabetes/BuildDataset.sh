...
limit=2644 # set this limit to create a balanced dataset

# clear previous run
output_dir=$scratch/retina/DL/output/utils/BuildDatasetDiabetes/
...
case_control_list="./Diabetes_cases-controls.csv"
