...
limit=750 # set this limit to create a balanced dataset

# clear previous run
output_dir=$scratch/retina/DL/output/utils/BuildDatasetStroke/
...
case_control_list="./Stroke_cases-controls.csv"
