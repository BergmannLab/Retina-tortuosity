...
df_data_qqnorm = df_data_qqnorm[[ 'medianDiameter_artery', 'medianDiameter_vein', 'DF_artery', 'DF_vein']]

df_data_qqnorm = df_data_qqnorm.replace({'-999': np.nan})
...
df_data_qqnorm = df_data_qqnorm.replace(np.nan, '-999')
df_data_qqnorm  = df_data_qqnorm.astype(str)
df_data_qqnorm = df_data_qqnorm.replace('nan', '-999')
...
#df_data2 = pd.read_csv("/scratch/beegfs/FAC/FBM/DBC/sbergman/retina/UKBiob/fundus/phenofiles/2022_02_13_multitrait_ageCorrectedVentile5QC.csv", sep=' ')

#df_data2 = df_data2[[ 'medianDiameter_artery', 'medianDiameter_vein', 'DF_artery', 'DF_vein']]
