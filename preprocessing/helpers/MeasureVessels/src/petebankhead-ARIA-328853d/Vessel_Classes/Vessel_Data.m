classdef Vessel_Data < hgsetget
    ...
    properties
        ...
        bw_mask;   % Mask image
        bw;        % Segmented image
        artery_vein_map;   % pixel-wise map indicating pseudoprobabilities 
                           % or being artery / vein or general vessels. It
                           % is generated by the AVUncertain SW
...
%                 set(findobj(ax, 'type', 'image'), 'CData', im2, 'CDataMapping', 'scaled');
    ...
    methods (Static)
        function obj = loadobj(obj)
            if isstruct(obj) || isa(obj, 'Vessel_Data')
                ...
                new_obj.artery_vein_map     = obj.artery_vein_map;
                new_obj.im          = obj.im;
    ...
    methods
        ...
        function obj = saveobj(obj)
            ...
            s.artery_vein_map     = obj.artery_vein_map;
            s.im           = obj.im;
