function [results, images] = REVIEW_evaluate_diameter_measurements(image_set, processor, chunk_start, chunk_size, minQCthr1, maxQCthr1, minQCthr2, maxQCthr2, path_to_raw, path_to_output) % mattia: added parameters
...
for ii = chunk_end:-1:chunk_start  %mattia: updating for loop accordingly
	...
	try
    	...
    	[vd_algorithm, processing_time(ii)] = Vessel_Data_IO.load_from_file(file_name, processor, settings, minQCthr1, maxQCthr1, minQCthr2, maxQCthr2, path_to_output);
	catch ME
