% ARIA_run_tests 0 REVIEW ../../fundus_UKBB/REVIEW/ ./ 1 3 11000 20000 100 250 ../../output
function ARIA_run_tests(f_name, test_name, path_to_raw, script_dir, chunk_start, chunk_size, minQCthr1, maxQCthr1, minQCthr2, maxQCthr2, path_to_output)
...
if any(strcmp({'review', 'all'}, test_name))
    ...
    for ii = numel(sets):-1:1
		...
		REVIEW(ii) = REVIEW_evaluate_diameter_measurements(sets{ii}, processor, chunk_start, chunk_size, minQCthr1, maxQCthr1, minQCthr2, maxQCthr2, path_to_raw, path_to_output);
    end
