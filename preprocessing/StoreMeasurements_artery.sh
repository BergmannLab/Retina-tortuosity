...
input_dir=$scratch/retina/preprocessing/output/MeasureVessels_artery/
backup_dir=$archive/retina/preprocessing/output/StoreMeasurements/$(date +%Y_%m_%d__%H_%M_%S)_artery
mkdir $backup_dir
