...
# raw covariates
usecols = ['eid', '31-0.0', '34-0.0', '53-0.0', '53-1.0']
# 34: year of birth
# 53: date visiting assessment center
...
covars_out['age'] = age_at_visit
covars_out['age-squared'] = np.round(np.square(age_at_visit), 2)
