...
#SBATCH --job-name=GWAS_tinnitus
#SBATCH --output=helpers/RunGWAS/slurm_runs_tinnitus/slurm-%x_%j.out
#SBATCH --error=helpers/RunGWAS/slurm_runs_tinnitus/slurm-%x_%j.err
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
experiment_id=2020_08_19__tinnitus # RENAME EXPERIMENT APPROPRIATELY
pheno_file=$scratch/retina/GWAS/output/VesselStatsToPhenofile/_tinnitus/"$experiment_id"/phenofile_resid_qqnorm.csv
