...
experiment_id=23-03-2022_BMIxy/ # RENAME EXPERIMENT APPROPRIATELY
pheno_file=$scratch/retina/GWAS/output/CreatePhenofile/"$experiment_id"/phenofile_qqnorm.csv
