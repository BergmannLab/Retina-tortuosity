...
hits <- hits[order(hits$AV_median_diameter.log10p, decreasing=TRUE), ] # order by pvalue
...
write.csv(result, paste0("GWAS_results_pruned_R2_", r2_thresh,"_",pop,"_all.csv"), row.names = F)
end.time <- Sys.time()
