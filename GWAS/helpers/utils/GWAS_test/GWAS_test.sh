...
bgen_file=$data/retina/UKBiob/genotypes/ukb_imp_chr21_v3.bgen
pheno_file=$HOME/retina/GWAS/helpers/utils/Extract_SBP_Phenotypes/output/4080-0.0,4080-0.1.csv
